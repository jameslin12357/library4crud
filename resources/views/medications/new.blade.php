    ...
    <div class="container pt-100">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <h3 class="login-heading mb-4 text-center">Create Medication</h3>
                <form action="/medications" method="post">
                    ...
                    @endif
                    <div class="form-group">
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Cost" value="{{ old('cost') }}" name="cost" required>
                    </div>
                    @if ($errors->has('cost'))
                        <span class="invalid-feedback" role="alert">
