        ...
        <div class="row">
            <div class="col-md-3">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row" class="active-tab"><a href="/visits">Visits</a></th>
                        <!--<td>Larry</td>-->
                        <!--<td>the Bird</td>-->
                        <!--<td>@twitter</td>-->
                    </tr>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        @if (Auth::user()->level === 1)
                            <th scope="col"><a href="/visits/create" class="btn btn-outline-secondary">Create</a></th>
                        @endif
                    ...
                    @foreach ($visits as $visit)
                        <tr>
                            ...
                            <td>{{ $visit->date_edited }}</td>
                            @if (Auth::user()->level === 1)
                                <td>
                                    <a href="/visits/{{ $visit->id }}/edit" class="btn btn-outline-secondary">Edit</a>
                                </td>
                                <td>
